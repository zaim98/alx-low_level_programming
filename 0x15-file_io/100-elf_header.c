#include "main.h"
/**
 * handle_exit - Entry poibt.
 * Description: This funtion handles the exit errors.
 ...
 * Description: This function checks if it's an elf file.
...
/**
 * display_elf_magic - Entry point.
 * Description: This function display_elf_magic.
 * @h: the header structure
 */
...
/**
 * display_elf_class - Entry point.
 * Description: This function display_elf_class.
 * @class: the class
 */
...
/**
 * display_elf_data - Entry point.
 * Description: This function display_elf_data
 * @data: the data
 */
...
/**
 * display_elf_version - Entnry poiny.
 * Description: This function display_elf_version
 * @version: the version
 */
...
/**
 * display_elf_osabi - Entry point.
 * Description: This function display_elf_osabi.
 * @osabi: the osabi
 */
...
/**
 * display_elf_type - Entry point.
 * Description: This code display_elf_type.
 * @type: the type
...
/**
 * display_elf_entry - Entry point.
 * Description: This code display_elf_entry.
...
/**
 * display_elf - Entry point.
 * Description: This function display_elf.
 * @h: the header structure
 */
